...
This repository contains the official documentation for our final project in the **Microsoft Certified Solutions Associate (MCSA) Windows Server** track, completed as part of the @Information Technology Institute (ITI) 9-Month Cloud Architecture program.
...
| :--- | :--- |
| **Active Directory** | Configuration of Root and Child Domains, Users, Groups, Organisational Units (OUs), Permissions, and Roaming Profiles. |
| **DNS** | Primary and Secondary DNS Zone implementation for robust name resolution. |
| **Group Policy (GPO)** | Deployment of Security Policies, Desktop Restrictions, USB Device Blocking, and centralised Software Deployment (e.g., WinRAR). |
| **Web Server (IIS)** | Hosting internal corporate websites with primary and secondary DNS configuration. |
| **Read-Only Domain Controller (RODC)** | Deployment and configuration for enhanced security in remote/less secure sites. |
